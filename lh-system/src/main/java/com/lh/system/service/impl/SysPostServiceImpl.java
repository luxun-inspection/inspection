...
public class SysPostServiceImpl implements ISysPostService
{
    ...
    @Override
    public SysPost selectPostNameByUserId(Long userId) {
        return postMapper.selectPostNameByUserId(userId);
    }

    @Override
    public int getMaxSort() {
        return postMapper.getMaxSort();
    }

    @Override
    public SysPost getSysPost(String postName) {
        return postMapper.getSysPost(postName);
    }

    @Override
    public Long getPostIdByUserId(Long userId) {
        return postMapper.getPostIdByUserId(userId);
    }
}
